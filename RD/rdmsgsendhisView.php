...
<script src="rdmsgsendhis.js?<?=getRndVal(10)?>"></script>
<script>
...
<!--<div id="BODY_BOX" class="BODY_BOX">--><!--그룹별 IO출력-->
	...
	#####################################################
	-->
    <div class="GRP_OBJECT" style="width:30%;height:600px;"> 
        <div class="GRP_GAP"><!--흰색 바깥 여백-->
		<div  class="GRID_LABELGRP">
			...
			<div id="div_gridG2_GRID_LABELBTN" class="GRID_LABELBTN"  style="">
				...
				<input type="button" class="btn btn-secondary  btn-sm" name="BTN_G2_ROWDEL" value="행삭제" onclick="G2_ROWDEL(uuidv4());">
