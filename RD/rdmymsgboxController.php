...
$REQ["G1-USR_SEQ"] = getFilter($REQ["G1-USR_SEQ"],"","//");	
...
$REQ["G1-FROM_ADD_DT"] = getFilter($REQ["G1-FROM_ADD_DT"],"","//");	
$REQ["G1-TO_ADD_DT"] = reqPostString("G1-TO_ADD_DT",14);//~, RORW=RW, INHERIT=N, METHOD=POST
$REQ["G1-TO_ADD_DT"] = getFilter($REQ["G1-TO_ADD_DT"],"","//");	
...
//G3, 수신상세 - RW속성 오브젝트만 필터 적용 ( RO속성은 제외 )
$REQ["G3-USR_SEQ"] = reqPostNumber("G3-USR_SEQ",10);//USR_SEQ, RORW=RW, INHERIT=N	
$REQ["G3-USR_SEQ"] = getFilter($REQ["G3-USR_SEQ"],"","//");	
...
switch ($ctl){
	...
	case "G3_SEARCH" :
		...
		break;
	case "G3_SAVE" :
		echo $objService->goG3Save(); //수신상세, 저장
		break;
	case "G3_DELETE" :
		echo $objService->goG3Delete(); //수신상세, 삭제
		break;
	default:
