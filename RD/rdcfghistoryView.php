...
<script src="rdcfghistory.js?<?=getRndVal(10)?>"></script>
<script>
		...
		<!--컨디션 IO리스트-->
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--CFG_SEQ오브젝트출력-->
						<input type="text" name="G1-CFG_SEQ" value="<?=getFilter(reqPostString("CFG_SEQ",99),"SAFEECHO","")?>" id="G1-CFG_SEQ" style="width:60px;text-align:" class="">
					</div>
				</div>
				<!--I.COLID : ACT_PGMID-->
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--ACT_PGMID오브젝트출력-->
						<input type="text" name="G1-ACT_PGMID" value="<?=getFilter(reqPostString("ACT_PGMID",99),"SAFEECHO","")?>" id="G1-ACT_PGMID" style="width:60px;text-align:" class="">
					</div>
				</div>
				<!--I.COLID : HOST_NM-->
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--HOST_NM오브젝트출력-->
						<input type="text" name="G1-HOST_NM" value="<?=getFilter(reqPostString("HOST_NM",99),"SAFEECHO","")?>" id="G1-HOST_NM" style="width:60px;text-align:" class="">
					</div>
				</div>
				<!--I.COLID : RESULT_YN-->
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--RESULT_YN오브젝트출력-->
						<input type="text" name="G1-RESULT_YN" value="<?=getFilter(reqPostString("RESULT_YN",99),"SAFEECHO","")?>" id="G1-RESULT_YN" style="width:60px;text-align:" class="">
					</div>
				</div>
				<!--I.COLID : RESULT_MSG-->
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--RESULT_MSG오브젝트출력-->
						<input type="text" name="G1-RESULT_MSG" value="<?=getFilter(reqPostString("RESULT_MSG",99),"SAFEECHO","")?>" id="G1-RESULT_MSG" style="width:60px;text-align:" class="">
					</div>
				</div>
				<!--I.COLID : ADD_DT-->
				<div class="CON_OBJGRP" style="">
			...
			<!--OBJECT LIST PRINT.-->
				...
				<div class="CON_OBJGRP" style="width:100%;">
					...
					<div class="CON_OBJECT" style="width:100%">
						<textarea  name="G3-OLD_CFG"  id="G3-OLD_CFG" style="padding:2px 2px 2px 2px;width:100%;height:240px"></textarea>
					</div>
				</div>
				...
				<div class="CON_OBJGRP" style="width:100%;">
					...
					<!--width:100%;height:240px-->
					<div class="CON_OBJECT" style="width:100%">
						<textarea  name="G3-NEW_CFG"  id="G3-NEW_CFG" style="padding:2px 2px 2px 2px;width:100%;height:240px"></textarea>
					</div>
				</div>
			</DIV><!--is_br_tab end-->
		</div>
