...
<script src="rdteammng.js?<?=getRndVal(10)?>"></script>
<script>
		...
		<!--컨디션 IO리스트-->
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--TEAMCD오브젝트출력-->
						<input type="text" name="G1-TEAMCD" value="<?=getFilter(reqPostString("TEAMCD",40),"SAFEECHO","")?>" id="G1-TEAMCD" style="width:100px;text-align:LEFT" class="">
					</div>
				</div>
				<!--I.COLID : TEAMNM-->
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--TEAMNM오브젝트출력-->
						<input type="text" name="G1-TEAMNM" value="<?=getFilter(reqPostString("TEAMNM",40),"SAFEECHO","")?>" id="G1-TEAMNM" style="width:100px;text-align:LEFT" class="">
					</div>
				</div>
			</div><!-- is_br_tag end -->
		</div>
    ...
    <div class="GRP_OBJECT" style="width:50%;height:300px;"> 
		...
		<div  class="GRID_LABELGRP">
			...
			<div id="div_gridG3_GRID_LABELBTN" class="GRID_LABELBTN"  style="">
				...
				<input type="button" class="btn btn-secondary  btn-sm" name="BTN_G3_CHKSAVE" value="선택 추가" onclick="G3_CHKSAVE(uuidv4());">
			</div>
			</div><!--GAP-->
		</div>
		<div  class="GRID_OBJECT" style="height:calc(100% - 37px);width:100%;">
