...
,				{ "COLID": "FILEHASH", "COLNM" : "FILEHASH", "OBJTYPE" : "INPUTBOXRO" }
,				{ "COLID": "FILESIZE", "COLNM" : "FILESIZE", "OBJTYPE" : "INPUTBOXRO" }
	...
	"G4", 
		{
			...
			,"COLS": [
				{ "COLID": "CHK", "COLNM" : "CHK", "OBJTYPE" : "ROWCHECK" }
,				{ "COLID": "ROWID", "COLNM" : "ROWID", "OBJTYPE" : "INPUTBOXRO" }
,				{ "COLID": "PGMID", "COLNM" : "프로그램ID", "OBJTYPE" : "INPUTBOXRO" }
...
//글로벌 변수 선언
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_SEARCHALL = "deploymngController?CTLGRP=G1&CTLFNC=SEARCHALL";
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_SAVE = "deploymngController?CTLGRP=G1&CTLFNC=SAVE";
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G1_RESET = "deploymngController?CTLGRP=G1&CTLFNC=RESET";
// 변수 선언	
var obj_G1_PJTSEQ; // PJTSEQ 변수선언
//그리드 변수 초기화	
//컨트롤러 경로
var url_G2_SEARCH = "deploymngController?CTLGRP=G2&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G2_SAVE = "deploymngController?CTLGRP=G2&CTLFNC=SAVE";
//컨트롤러 경로
var url_G2_RELOAD = "deploymngController?CTLGRP=G2&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G2_HIDDENCOL = "deploymngController?CTLGRP=G2&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G2_EXCEL = "deploymngController?CTLGRP=G2&CTLFNC=EXCEL";
//컨트롤러 경로
var url_G2_CHKSAVE = "deploymngController?CTLGRP=G2&CTLFNC=CHKSAVE";
//그리드 객체
var mygridG2,isToggleHiddenColG2,lastinputG2,lastinputG2json,lastrowidG2;
var lastselectG2json;//그리드 변수 초기화	
//컨트롤러 경로
var url_G3_SEARCH = "deploymngController?CTLGRP=G3&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G3_SAVE = "deploymngController?CTLGRP=G3&CTLFNC=SAVE";
//컨트롤러 경로
var url_G3_RELOAD = "deploymngController?CTLGRP=G3&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G3_HIDDENCOL = "deploymngController?CTLGRP=G3&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G3_EXCEL = "deploymngController?CTLGRP=G3&CTLFNC=EXCEL";
//컨트롤러 경로
var url_G3_CHKSAVE = "deploymngController?CTLGRP=G3&CTLFNC=CHKSAVE";
//그리드 객체
var mygridG3,isToggleHiddenColG3,lastinputG3,lastinputG3json,lastrowidG3;
var lastselectG3json;//그리드 변수 초기화	
//컨트롤러 경로
var url_G4_SEARCH = "deploymngController?CTLGRP=G4&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G4_SAVE = "deploymngController?CTLGRP=G4&CTLFNC=SAVE";
//컨트롤러 경로
var url_G4_RELOAD = "deploymngController?CTLGRP=G4&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G4_HIDDENCOL = "deploymngController?CTLGRP=G4&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G4_EXCEL = "deploymngController?CTLGRP=G4&CTLFNC=EXCEL";
//컨트롤러 경로
var url_G4_CHKSAVE = "deploymngController?CTLGRP=G4&CTLFNC=CHKSAVE";
//그리드 객체
...
function G2_INIT(){
  alog("G2_INIT()-------------------------start");
	...
	mygridG2.setColSorting("na,int,int,str,str,str,str,str,str,str");	//렌더링	
...
function G3_INIT(){
  alog("G3_INIT()-------------------------start");
	...
	//헤더초기화
	mygridG3.setHeader("#master_checkbox,PGMSEQ,프로그램ID,프로그램이름,PKGGRP,VIEWURL,PGMTYPE,SECTYPE,ADDDT,MODDT");
	mygridG3.setColumnIds("CHK,PGMSEQ,PGMID,PGMNM,PKGGRP,VIEWURL,PGMTYPE,SECTYPE,ADDDT,MODDT");
	mygridG3.setInitWidths("50,50,200,100,40,100,60,60,60,60");
	mygridG3.setColTypes("ch,ro,ro,ro,ed,ed,co,co,ro,ro");
	//가로 정렬	
	mygridG3.setColAlign("left,left,left,left,left,left,left,left,left,left");
	mygridG3.setColSorting("na,int,str,str,str,str,str,str,str,str");	//렌더링	
...
function G4_INIT(){
  alog("G4_INIT()-------------------------start");
	...
	mygridG4.setColSorting("na,str,str,str,str");	//렌더링	
	...
	var conAllData = "";
        ...
        $.ajax({
            ...
            error: function(error){
                ...
                alog("[파일] Ajax http 500 error ( " + data.RTN_MSG + " )");
            }
        });
        alog("G2_SEARCH()------------end");
    }
	...
	var conAllData = "";
        ...
        $.ajax({
            ...
            error: function(error){
                ...
                alog("[SQL PGM] Ajax http 500 error ( " + data.RTN_MSG + " )");
            }
        });
        alog("G3_SEARCH()------------end");
    }
	...
	var conAllData = "";
        ...
        $.ajax({
            ...
            error: function(error){
                ...
                alog("[SQL AUTH] Ajax http 500 error ( " + data.RTN_MSG + " )");
            }
        });
        alog("G4_SEARCH()------------end");
    }
