...
<script src="iconmng1.js?<?=getRndVal(10)?>"></script>
<script>
		...
		<div style="height:452px;" class="FORMVIEW_OBJECT">
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--ICONSEQ오브젝트출력-->
						<input type="text" name="G3-ICONSEQ" value="" id="G3-ICONSEQ" style="width:200;text-align:LEFT" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--IMGNM오브젝트출력-->
						<input type="text" name="G3-IMGNM" value="" id="G3-IMGNM" style="width:200;text-align:LEFT" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--IMGSIZE오브젝트출력-->
						<input type="text" name="G3-IMGSIZE" value="" id="G3-IMGSIZE" style="width:200;text-align:LEFT" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--IMGSVRNM오브젝트출력-->
						<input type="text" name="G3-IMGSVRNM" value="" id="G3-IMGSVRNM" style="width:200;text-align:LEFT" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--IMGHASH오브젝트출력-->
						<input type="text" name="G3-IMGHASH" value="" id="G3-IMGHASH" style="width:200;text-align:LEFT" class="">
					</div>
				</div>
			</DIV>
			<DIV class="OBJ_BR"></DIV>
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<!--width:200px;height:44-->
					<div class="CON_OBJECT" style="">
						<textarea  name="G3-TXTAREA"  id="G3-TXTAREA" style="padding:2px 2px 2px 2px;width:200px;height:44"></textarea>
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:200;"-->
					<div class="CON_OBJECT">
						<div name="G3-TXTVIEW" id="G3-TXTVIEW" style="background-color:white; width:200;height:22;line-height:22px;vertical-align:middle;padding:0px 0px 0px 3px"></div>
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT" style="width:200px;">
						<select id="G3-IMGTYPE5" name="G3-IMGTYPE5" 
							style="width:200px"
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<input type="text" name="G3-ADDDT2" value="" id="G3-ADDDT2" style="width:177;" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--ADDDT오브젝트출력-->
						<input type="text" name="G3-ADDDT" value="" id="G3-ADDDT" style="width:200;text-align:LEFT" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
		</div>
