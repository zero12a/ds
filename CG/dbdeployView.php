...
<script src="dbdeploy.js?<?=getRndVal(10)?>"></script>
<script>
...
<!--<div id="BODY_BOX" class="BODY_BOX">--><!--그룹별 IO출력-->
		...
		<!--컨디션 IO리스트-->
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--DB오브젝트출력-->
						<input type="text" name="G1-DB" value="<?=getFilter(reqPostString("DB",30),"SAFEECHO","")?>" id="G1-DB" style="width:100;text-align:LEFT" class="">
					</div>
				</div>
				<!--I.COLID : TARGET_DB-->
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--TARGET_DB오브젝트출력-->
						<input type="text" name="G1-TARGET_DB" value="<?=getFilter(reqPostString("TARGET_DB",100),"SAFEECHO","")?>" id="G1-TARGET_DB" style="width:100;text-align:LEFT" class="">
					</div>
				</div>
			</div><!-- is_br_tag end -->
		</div>
    ...
    <div class="GRP_OBJECT" style="width:50%;" id="layout_G3">
		...
		<div style="height:452px;" class="FORMVIEW_OBJECT">
			<DIV class="CON_LINE" is_br_tag>
			<!--OBJECT LIST PRINT.-->
				<!--I.COLID : TABLE_SCHEMA-->
				<div class="CON_OBJGRP" style="">
					<div class="CON_LABEL" style="width:100;text-align:;">	
					DB	
					</div>
					<!-- style="width:120;"-->
					<div class="CON_OBJECT">
						<div name="G3-TABLE_SCHEMA" id="G3-TABLE_SCHEMA" style="background-color:white; width:120;height:;line-height:px;vertical-align:middle;padding:0px 0px 0px 3px"></div>
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:120;"-->
					<div class="CON_OBJECT">
						<div name="G3-TABLE_NAME" id="G3-TABLE_NAME" style="background-color:white; width:120;height:;line-height:px;vertical-align:middle;padding:0px 0px 0px 3px"></div>
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:120;"-->
					<div class="CON_OBJECT">
						<div name="G3-ENGINE" id="G3-ENGINE" style="background-color:white; width:120;height:;line-height:px;vertical-align:middle;padding:0px 0px 0px 3px"></div>
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:120;"-->
					<div class="CON_OBJECT">
						<div name="G3-TABLE_ROWS" id="G3-TABLE_ROWS" style="background-color:white; width:120;height:;line-height:px;vertical-align:middle;padding:0px 0px 0px 3px"></div>
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			<DIV class="CON_LINE" is_br_tag>
				<!--I.COLID : AUTO_INCREMENT-->
				<div class="CON_OBJGRP" style="">
					<div class="CON_LABEL" style="width:100;text-align:;">	
					AI	
					</div>
					<!-- style="width:120;"-->
					<div class="CON_OBJECT">
						<div name="G3-AUTO_INCREMENT" id="G3-AUTO_INCREMENT" style="background-color:white; width:120;height:;line-height:px;vertical-align:middle;padding:0px 0px 0px 3px"></div>
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:120;"-->
					<div class="CON_OBJECT">
						<div name="G3-CREATE_TIME" id="G3-CREATE_TIME" style="background-color:white; width:120;height:;line-height:px;vertical-align:middle;padding:0px 0px 0px 3px"></div>
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:120;"-->
					<div class="CON_OBJECT">
						<div name="G3-UPDATE_TIME" id="G3-UPDATE_TIME" style="background-color:white; width:120;height:;line-height:px;vertical-align:middle;padding:0px 0px 0px 3px"></div>
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			<DIV class="CON_LINE" is_br_tag>
				<!--I.COLID : TABLE_COLLATION-->
				<div class="CON_OBJGRP" style="">
					<div class="CON_LABEL" style="width:100;text-align:;">	
					COLLATION	
					</div>
					<!-- style="width:120;"-->
					<div class="CON_OBJECT">
						<div name="G3-TABLE_COLLATION" id="G3-TABLE_COLLATION" style="background-color:white; width:120;height:;line-height:px;vertical-align:middle;padding:0px 0px 0px 3px"></div>
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			<DIV class="CON_LINE" is_br_tag>
				<!--I.COLID : TABLE_COMMENT-->
				<div class="CON_OBJGRP" style="">
					<div class="CON_LABEL" style="width:100;text-align:;">	
					COMMENT	
					</div>
					<!-- style="width:120;"-->
					<div class="CON_OBJECT">
						<div name="G3-TABLE_COMMENT" id="G3-TABLE_COMMENT" style="background-color:white; width:120;height:;line-height:px;vertical-align:middle;padding:0px 0px 0px 3px"></div>
					</div>
				</div>
			</DIV><!--is_br_tab end-->
		</div>
