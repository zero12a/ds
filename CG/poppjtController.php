...
require_once('poppjtService.php');
...
$log->info("PoppjtControl___________________________start");
...
//G2, 프로젝트 - RW속성 오브젝트만 필터 적용 ( RO속성은 제외 )
...
array_push($_RTIME,array("[TIME 40.REQ_VALID]",microtime(true)));
	//서비스 클래스 생성
$objService = new poppjtService($REQ);
//컨트롤 명령별 분개처리
$log->info("ctl:" . $ctl);
switch ($ctl){
		case "G1_SEARCHALL" :
...
$log->info("PoppjtControl___________________________end");
$log->close(); unset($log);
?>
