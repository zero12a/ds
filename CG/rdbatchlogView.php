...
<script src="rdbatchlog.js?<?=getRndVal(10)?>"></script>
<script>
		...
		<!--컨디션 IO리스트-->
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<input type="text" name="G2-FROM_ADD_DT" value="" id="G2-FROM_ADD_DT" style="width:87px;" class="">
					</div>
				</div>
				<!--I.COLID : TO_ADD_DT-->
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<input type="text" name="G2-TO_ADD_DT" value="" id="G2-TO_ADD_DT" style="width:87px;" class="">
					</div>
				</div>
			</div><!-- is_br_tag end -->
		</div>
