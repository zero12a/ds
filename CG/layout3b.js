...
//글로벌 변수 선언
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G2_USERDEF = "layout3bController?CTLGRP=G2&CTLFNC=USERDEF";
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G2_SEARCHALL = "layout3bController?CTLGRP=G2&CTLFNC=SEARCHALL";
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G2_SAVE = "layout3bController?CTLGRP=G2&CTLFNC=SAVE";
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G2_RESET = "layout3bController?CTLGRP=G2&CTLFNC=RESET";
// 변수 선언	
var obj_G2_LAYOUTID; // LAYOUTID 변수선언
var obj_G2_ADDDT; // ADDDT 변수선언
//그리드 변수 초기화	
//컨트롤러 경로
var url_G3_USERDEF = "layout3bController?CTLGRP=G3&CTLFNC=USERDEF";
//컨트롤러 경로
var url_G3_SEARCH = "layout3bController?CTLGRP=G3&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G3_SAVE = "layout3bController?CTLGRP=G3&CTLFNC=SAVE";
//컨트롤러 경로
var url_G3_ROWDELETE = "layout3bController?CTLGRP=G3&CTLFNC=ROWDELETE";
//컨트롤러 경로
var url_G3_ROWBULKADD = "layout3bController?CTLGRP=G3&CTLFNC=ROWBULKADD";
//컨트롤러 경로
var url_G3_ROWADD = "layout3bController?CTLGRP=G3&CTLFNC=ROWADD";
//컨트롤러 경로
var url_G3_RELOAD = "layout3bController?CTLGRP=G3&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G3_HIDDENCOL = "layout3bController?CTLGRP=G3&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G3_EXCEL = "layout3bController?CTLGRP=G3&CTLFNC=EXCEL";
//컨트롤러 경로
var url_G3_EDITMODE = "layout3bController?CTLGRP=G3&CTLFNC=EDITMODE";
//컨트롤러 경로
var url_G3_CHKSAVE = "layout3bController?CTLGRP=G3&CTLFNC=CHKSAVE";
//그리드 객체
var mygridG3,isToggleHiddenColG3,lastinputG3,lastinputG3json,lastrowidG3;
var lastselectG3json;//그리드 변수 초기화	
//컨트롤러 경로
var url_G4_ROWBULKADD = "layout3bController?CTLGRP=G4&CTLFNC=ROWBULKADD";
//컨트롤러 경로
var url_G4_ROWADD = "layout3bController?CTLGRP=G4&CTLFNC=ROWADD";
//컨트롤러 경로
var url_G4_RELOAD = "layout3bController?CTLGRP=G4&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G4_HIDDENCOL = "layout3bController?CTLGRP=G4&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G4_EXCEL = "layout3bController?CTLGRP=G4&CTLFNC=EXCEL";
//컨트롤러 경로
var url_G4_EDITMODE = "layout3bController?CTLGRP=G4&CTLFNC=EDITMODE";
//컨트롤러 경로
var url_G4_CHKSAVE = "layout3bController?CTLGRP=G4&CTLFNC=CHKSAVE";
//컨트롤러 경로
var url_G4_USERDEF = "layout3bController?CTLGRP=G4&CTLFNC=USERDEF";
//컨트롤러 경로
var url_G4_SEARCH = "layout3bController?CTLGRP=G4&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G4_SAVE = "layout3bController?CTLGRP=G4&CTLFNC=SAVE";
//컨트롤러 경로
var url_G4_ROWDELETE = "layout3bController?CTLGRP=G4&CTLFNC=ROWDELETE";
//그리드 객체
...
function G4_INIT(){
  alog("G4_INIT()-------------------------start");
	...
	//헤더초기화
	mygridG4.setHeader("LAYOUTSSEQ,ADDDT");
	mygridG4.setColumnIds("LAYOUTSSEQ,ADDDT");
	mygridG4.setInitWidths("60px,70px");
	mygridG4.setColTypes("ed,ed");
	//가로 정렬	
	mygridG4.setColAlign("left,left");
	mygridG4.setColSorting("int,str");	//렌더링	
	mygridG4.enableSmartRendering(true);
	mygridG4.enableMultiselect(true);
	//mygridG4.setColValidators("G4_LAYOUTSSEQ,G4_ADDDT");
