...
require_once('layout3cService.php');
...
$log->info("Layout3cControl___________________________start");
...
}else if($objAuth->isAuth("LAYOUT3C",$ctl)){
	$objAuth->LAUTH_SEQ = $objAuth->logUsrAuth($reqToken,$resToken,"LAYOUT3C",$ctl,"Y");
}else{
	$objAuth->logUsrAuth($reqToken,$resToken,"LAYOUT3C",$ctl,"N");
...
$log->info("Layout3cControl___________________________end");
$log->close(); unset($log);
?>
