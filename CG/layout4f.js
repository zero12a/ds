...
//글로벌 변수 선언
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G2_USERDEF = "layout4fController?CTLGRP=G2&CTLFNC=USERDEF";
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G2_SEARCHALL = "layout4fController?CTLGRP=G2&CTLFNC=SEARCHALL";
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G2_SAVE = "layout4fController?CTLGRP=G2&CTLFNC=SAVE";
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G2_RESET = "layout4fController?CTLGRP=G2&CTLFNC=RESET";
// 변수 선언	
var obj_G2_LAYOUTID; // LAYOUTID 변수선언
var obj_G2_ADDDT; // ADDDT 변수선언
//그리드 변수 초기화	
//컨트롤러 경로
var url_G4_USERDEF = "layout4fController?CTLGRP=G4&CTLFNC=USERDEF";
//컨트롤러 경로
var url_G4_SEARCH = "layout4fController?CTLGRP=G4&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G4_SAVE = "layout4fController?CTLGRP=G4&CTLFNC=SAVE";
//컨트롤러 경로
var url_G4_ROWDELETE = "layout4fController?CTLGRP=G4&CTLFNC=ROWDELETE";
//컨트롤러 경로
var url_G4_ROWBULKADD = "layout4fController?CTLGRP=G4&CTLFNC=ROWBULKADD";
//컨트롤러 경로
var url_G4_ROWADD = "layout4fController?CTLGRP=G4&CTLFNC=ROWADD";
//컨트롤러 경로
var url_G4_RELOAD = "layout4fController?CTLGRP=G4&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G4_HIDDENCOL = "layout4fController?CTLGRP=G4&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G4_EXCEL = "layout4fController?CTLGRP=G4&CTLFNC=EXCEL";
//컨트롤러 경로
var url_G4_EDITMODE = "layout4fController?CTLGRP=G4&CTLFNC=EDITMODE";
//컨트롤러 경로
var url_G4_CHKSAVE = "layout4fController?CTLGRP=G4&CTLFNC=CHKSAVE";
//그리드 객체
var mygridG4,isToggleHiddenColG4,lastinputG4,lastinputG4json,lastrowidG4;
var lastselectG4json;//그리드 변수 초기화	
//컨트롤러 경로
var url_G5_USERDEF = "layout4fController?CTLGRP=G5&CTLFNC=USERDEF";
//컨트롤러 경로
var url_G5_SEARCH = "layout4fController?CTLGRP=G5&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G5_SAVE = "layout4fController?CTLGRP=G5&CTLFNC=SAVE";
//컨트롤러 경로
var url_G5_ROWDELETE = "layout4fController?CTLGRP=G5&CTLFNC=ROWDELETE";
//컨트롤러 경로
var url_G5_ROWBULKADD = "layout4fController?CTLGRP=G5&CTLFNC=ROWBULKADD";
//컨트롤러 경로
var url_G5_ROWADD = "layout4fController?CTLGRP=G5&CTLFNC=ROWADD";
//컨트롤러 경로
var url_G5_RELOAD = "layout4fController?CTLGRP=G5&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G5_HIDDENCOL = "layout4fController?CTLGRP=G5&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G5_EXCEL = "layout4fController?CTLGRP=G5&CTLFNC=EXCEL";
//컨트롤러 경로
var url_G5_EDITMODE = "layout4fController?CTLGRP=G5&CTLFNC=EDITMODE";
//컨트롤러 경로
var url_G5_CHKSAVE = "layout4fController?CTLGRP=G5&CTLFNC=CHKSAVE";
//그리드 객체
var mygridG5,isToggleHiddenColG5,lastinputG5,lastinputG5json,lastrowidG5;
var lastselectG5json;//그리드 변수 초기화	
//컨트롤러 경로
var url_G6_USERDEF = "layout4fController?CTLGRP=G6&CTLFNC=USERDEF";
//컨트롤러 경로
var url_G6_SEARCH = "layout4fController?CTLGRP=G6&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G6_SAVE = "layout4fController?CTLGRP=G6&CTLFNC=SAVE";
//컨트롤러 경로
var url_G6_ROWDELETE = "layout4fController?CTLGRP=G6&CTLFNC=ROWDELETE";
//컨트롤러 경로
var url_G6_ROWBULKADD = "layout4fController?CTLGRP=G6&CTLFNC=ROWBULKADD";
//컨트롤러 경로
var url_G6_ROWADD = "layout4fController?CTLGRP=G6&CTLFNC=ROWADD";
//컨트롤러 경로
var url_G6_RELOAD = "layout4fController?CTLGRP=G6&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G6_HIDDENCOL = "layout4fController?CTLGRP=G6&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G6_EXCEL = "layout4fController?CTLGRP=G6&CTLFNC=EXCEL";
//컨트롤러 경로
var url_G6_EDITMODE = "layout4fController?CTLGRP=G6&CTLFNC=EDITMODE";
//컨트롤러 경로
var url_G6_CHKSAVE = "layout4fController?CTLGRP=G6&CTLFNC=CHKSAVE";
//그리드 객체
...
function L1_INIT(){
	...
	Split(['#layout_G2','#layout_L3','#layout_G6'], {
	direction: 'vertical',
	gutterSize: 6,
	sizes : [0,50,50],
	minSize : [80,0,100],
...
function G4_INIT(){
  alog("G4_INIT()-------------------------start");
	...
	mygridG4.setUserData("","gridTitle","G4 : "); //글로별 변수에 그리드 타이블 넣기
	//헤더초기화
	mygridG4.setHeader("LAYOUTID,ADDDT");
	mygridG4.setColumnIds("LAYOUTID,ADDDT");
	mygridG4.setInitWidths("60,70");
	...
	//onCheck
		...
		lastinputG6.set("G4-LAYOUTID", mygridG4.cells(rowID,mygridG4.getColIndexById("LAYOUTID")).getValue().replace(/&amp;/g, "&")); // 
			...
			G6_SEARCH(lastinputG6,uuidv4()); //자식그룹 호출 : 
		});
	//onEditCell 이벤트
...
function G5_INIT(){
  alog("G5_INIT()-------------------------start");
	...
	mygridG5.setUserData("","gridTitle","G5 : "); //글로별 변수에 그리드 타이블 넣기
	//헤더초기화
	mygridG5.setHeader("LAYOUTDSEQ,ADDDT");
	mygridG5.setColumnIds("LAYOUTDSEQ,ADDDT");
	mygridG5.setInitWidths("60,70");
...
function G6_INIT(){
  alog("G6_INIT()-------------------------start");
	...
	mygridG6.setUserData("","gridTitle","G6 : "); //글로별 변수에 그리드 타이블 넣기
	//헤더초기화
	mygridG6.setHeader("LAYOUTSSEQ,ADDDT");
	mygridG6.setColumnIds("LAYOUTSSEQ,ADDDT");
	mygridG6.setInitWidths("60,70");
