...
<script src="grpusrmng.js?<?=getRndVal(10)?>"></script>
<script>
		...
		<!--컨디션 IO리스트-->
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--GRP_NM오브젝트출력-->
						<input type="text" name="G1-GRP_NM" value="<?=getFilter(reqPostString("GRP_NM",30),"SAFEECHO","")?>" id="G1-GRP_NM" style="width:60;text-align:LEFT" class="">
					</div>
				</div>
				<!--I.COLID : USE_YN-->
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--USE_YN오브젝트출력-->
						<input type="text" name="G1-USE_YN" value="<?=getFilter(reqPostString("USE_YN",1),"SAFEECHO","")?>" id="G1-USE_YN" style="width:;text-align:LEFT" class="">
					</div>
				</div>
			</div><!-- is_br_tag end -->
		</div>
