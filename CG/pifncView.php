		...
		<!--컨디션 IO리스트-->
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--FNCID오브젝트출력-->
						<input type="text" name="G1-FNCID" value="<?=getFilter(reqPostString("FNCID",30),"SAFEECHO","")?>" id="G1-FNCID" style="width:70;text-align:LEFT" class="">
					</div>
				</div>
					<!-- GRPSEQ -->
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--FNCNM오브젝트출력-->
						<input type="text" name="G1-FNCNM" value="<?=getFilter(reqPostString("FNCNM",30),"SAFEECHO","")?>" id="G1-FNCNM" style="width:70;text-align:LEFT" class="">
					</div>
				</div>
			</div><!-- is_br_tag end -->
		</div>
		...
		<div style="height:452px;" class="FORMVIEW_OBJECT">
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--FNCSEQ오브젝트출력-->
						<input type="text" name="G3-FNCSEQ" value="" id="G3-FNCSEQ" style="width:60;text-align:LEFT" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--FNCID오브젝트출력-->
						<input type="text" name="G3-FNCID" value="" id="G3-FNCID" style="width:100;text-align:LEFT" class="">
					</div>
				</div>
			</DIV>
			<DIV class="OBJ_BR"></DIV>
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--FNCNM오브젝트출력-->
						<input type="text" name="G3-FNCNM" value="" id="G3-FNCNM" style="width:100;text-align:LEFT" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--FNCTYPE오브젝트출력-->
						<input type="text" name="G3-FNCTYPE" value="" id="G3-FNCTYPE" style="width:100;text-align:LEFT" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--FNCORD오브젝트출력-->
						<input type="text" name="G3-FNCORD" value="" id="G3-FNCORD" style="width:70;text-align:LEFT" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
