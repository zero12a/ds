...
<!--<div id="BODY_BOX" class="BODY_BOX">--><!--그룹별 IO출력-->
		...
		<!--컨디션 IO리스트-->
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--PGMID오브젝트출력-->
						<input type="text" name="G1-PGMID" value="<?=getFilter(reqPostString("PGMID",20),"SAFEECHO","")?>" id="G1-PGMID" style="width:100;text-align:" class="">
					</div>
				</div>
				<!--I.COLID : PJTSEQ-->
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--PJTSEQ오브젝트출력-->
						<input type="text" name="G1-PJTSEQ" value="<?=getFilter(reqPostString("PJTSEQ",20),"SAFEECHO","")?>" id="G1-PJTSEQ" style="width:30;text-align:" class="">
					</div>
				</div>
			</div><!-- is_br_tag end -->
		</div>
	...
	#####################################################
	-->
    <div class="GRP_OBJECT" style="width:100%;height:700px;">
        <div class="GRP_GAP"><!--흰색 바깥 여백-->
