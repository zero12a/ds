...
require_once('layout4iService.php');
...
$log->info("Layout4iControl___________________________start");
...
array_push($_RTIME,array("[TIME 40.REQ_VALID]",microtime(true)));
	//서비스 클래스 생성
$objService = new layout4iService($REQ);
//컨트롤 명령별 분개처리
$log->info("ctl:" . $ctl);
switch ($ctl){
		case "G2_SEARCHALL" :
...
$log->info("Layout4iControl___________________________end");
$log->close(); unset($log);
?>
