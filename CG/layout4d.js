...
//글로벌 변수 선언
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G2_USERDEF = "layout4dController?CTLGRP=G2&CTLFNC=USERDEF";
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G2_SEARCHALL = "layout4dController?CTLGRP=G2&CTLFNC=SEARCHALL";
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G2_SAVE = "layout4dController?CTLGRP=G2&CTLFNC=SAVE";
//버틀 그룹쪽에서 컨틀롤러 호출
var url_G2_RESET = "layout4dController?CTLGRP=G2&CTLFNC=RESET";
// 변수 선언	
var obj_G2_LAYOUTID; // LAYOUTID 변수선언
var obj_G2_ADDDT; // ADDDT 변수선언
//그리드 변수 초기화	
//컨트롤러 경로
var url_G3_USERDEF = "layout4dController?CTLGRP=G3&CTLFNC=USERDEF";
//컨트롤러 경로
var url_G3_SEARCH = "layout4dController?CTLGRP=G3&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G3_SAVE = "layout4dController?CTLGRP=G3&CTLFNC=SAVE";
//컨트롤러 경로
var url_G3_ROWDELETE = "layout4dController?CTLGRP=G3&CTLFNC=ROWDELETE";
//컨트롤러 경로
var url_G3_ROWBULKADD = "layout4dController?CTLGRP=G3&CTLFNC=ROWBULKADD";
//컨트롤러 경로
var url_G3_ROWADD = "layout4dController?CTLGRP=G3&CTLFNC=ROWADD";
//컨트롤러 경로
var url_G3_RELOAD = "layout4dController?CTLGRP=G3&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G3_HIDDENCOL = "layout4dController?CTLGRP=G3&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G3_EXCEL = "layout4dController?CTLGRP=G3&CTLFNC=EXCEL";
//컨트롤러 경로
var url_G3_EDITMODE = "layout4dController?CTLGRP=G3&CTLFNC=EDITMODE";
//컨트롤러 경로
var url_G3_CHKSAVE = "layout4dController?CTLGRP=G3&CTLFNC=CHKSAVE";
//그리드 객체
var mygridG3,isToggleHiddenColG3,lastinputG3,lastinputG3json,lastrowidG3;
var lastselectG3json;//그리드 변수 초기화	
//컨트롤러 경로
var url_G4_USERDEF = "layout4dController?CTLGRP=G4&CTLFNC=USERDEF";
//컨트롤러 경로
var url_G4_SEARCH = "layout4dController?CTLGRP=G4&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G4_SAVE = "layout4dController?CTLGRP=G4&CTLFNC=SAVE";
//컨트롤러 경로
var url_G4_ROWDELETE = "layout4dController?CTLGRP=G4&CTLFNC=ROWDELETE";
//컨트롤러 경로
var url_G4_ROWBULKADD = "layout4dController?CTLGRP=G4&CTLFNC=ROWBULKADD";
//컨트롤러 경로
var url_G4_ROWADD = "layout4dController?CTLGRP=G4&CTLFNC=ROWADD";
//컨트롤러 경로
var url_G4_RELOAD = "layout4dController?CTLGRP=G4&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G4_HIDDENCOL = "layout4dController?CTLGRP=G4&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G4_EXCEL = "layout4dController?CTLGRP=G4&CTLFNC=EXCEL";
//컨트롤러 경로
var url_G4_EDITMODE = "layout4dController?CTLGRP=G4&CTLFNC=EDITMODE";
//컨트롤러 경로
var url_G4_CHKSAVE = "layout4dController?CTLGRP=G4&CTLFNC=CHKSAVE";
//그리드 객체
var mygridG4,isToggleHiddenColG4,lastinputG4,lastinputG4json,lastrowidG4;
var lastselectG4json;//그리드 변수 초기화	
//컨트롤러 경로
var url_G5_USERDEF = "layout4dController?CTLGRP=G5&CTLFNC=USERDEF";
//컨트롤러 경로
var url_G5_SEARCH = "layout4dController?CTLGRP=G5&CTLFNC=SEARCH";
//컨트롤러 경로
var url_G5_SAVE = "layout4dController?CTLGRP=G5&CTLFNC=SAVE";
//컨트롤러 경로
var url_G5_ROWDELETE = "layout4dController?CTLGRP=G5&CTLFNC=ROWDELETE";
//컨트롤러 경로
var url_G5_ROWBULKADD = "layout4dController?CTLGRP=G5&CTLFNC=ROWBULKADD";
//컨트롤러 경로
var url_G5_ROWADD = "layout4dController?CTLGRP=G5&CTLFNC=ROWADD";
//컨트롤러 경로
var url_G5_RELOAD = "layout4dController?CTLGRP=G5&CTLFNC=RELOAD";
//컨트롤러 경로
var url_G5_HIDDENCOL = "layout4dController?CTLGRP=G5&CTLFNC=HIDDENCOL";
//컨트롤러 경로
var url_G5_EXCEL = "layout4dController?CTLGRP=G5&CTLFNC=EXCEL";
//컨트롤러 경로
var url_G5_EDITMODE = "layout4dController?CTLGRP=G5&CTLFNC=EDITMODE";
//컨트롤러 경로
var url_G5_CHKSAVE = "layout4dController?CTLGRP=G5&CTLFNC=CHKSAVE";
//그리드 객체
...
function L1_INIT(){
	...
	Split(['#layout_G2','#layout_G3','#layout_G4','#layout_G5'], {
	direction: 'vertical',
	gutterSize: 6,
	sizes : [0,33,33,34],
	minSize : [80,100,100,100],
...
function G3_INIT(){
  alog("G3_INIT()-------------------------start");
	...
	//onCheck
		...
		'}');
		lastinputG4 = new HashMap(); // D
		lastinputG4.set("__ROWID",rowID);
		lastinputG4.set("G3-LAYOUTID", mygridG3.cells(rowID,mygridG3.getColIndexById("LAYOUTID")).getValue().replace(/&amp;/g, "&")); // 
		lastinputG5json = jQuery.parseJSON('{ "__NAME":"lastinputG5json"' +
			', "G3-LAYOUTID" : "' + q(mygridG3.cells(rowID,mygridG3.getColIndexById("LAYOUTID")).getValue()) + '"' +
		'}');
		lastinputG5 = new HashMap(); // S
		...
		lastinputG5.set("G3-LAYOUTID", mygridG3.cells(rowID,mygridG3.getColIndexById("LAYOUTID")).getValue().replace(/&amp;/g, "&")); // 
			G4_SEARCH(lastinputG4,uuidv4()); //자식그룹 호출 : D
			G5_SEARCH(lastinputG5,uuidv4()); //자식그룹 호출 : S
		});
	//onEditCell 이벤트
...
function G4_INIT(){
  alog("G4_INIT()-------------------------start");
	...
	mygridG4.setUserData("","gridTitle","G4 : D"); //글로별 변수에 그리드 타이블 넣기
	//헤더초기화
	mygridG4.setHeader("LAYOUTDSEQ,ADDDT");
	mygridG4.setColumnIds("LAYOUTDSEQ,ADDDT");
	...
	//mygridG4.setColValidators("G4_LAYOUTDSEQ,G4_ADDDT");
...
function G5_INIT(){
  alog("G5_INIT()-------------------------start");
	...
	mygridG5.setUserData("","gridTitle","G5 : S"); //글로별 변수에 그리드 타이블 넣기
	//헤더초기화
	mygridG5.setHeader("LAYOUTSSEQ,ADDDT");
	mygridG5.setColumnIds("LAYOUTSSEQ,ADDDT");
	mygridG5.setInitWidths("60px,70px");
	mygridG5.setColTypes("ed,ed");
	//가로 정렬	
	mygridG5.setColAlign("left,left");
	mygridG5.setColSorting("int,str");	//렌더링	
	mygridG5.enableSmartRendering(true);
	mygridG5.enableMultiselect(true);
	//mygridG5.setColValidators("G5_LAYOUTSSEQ,G5_ADDDT");
