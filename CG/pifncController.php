...
$log->info("PifncControl___________________________start");
...
$REQ["G1-FNCID"] = reqPostString("G1-FNCID",30);//FNCID, RORW=RW, INHERIT=N, METHOD=POST
$REQ["G1-FNCID"] = getFilter($REQ["G1-FNCID"],"CLEARTEXT","/--미 정의--/");	
$REQ["G1-FNCNM"] = reqPostString("G1-FNCNM",30);//FNCNM, RORW=RW, INHERIT=N, METHOD=POST
...
$REQ["G2-FNCSEQ"] = reqPostString("G2-FNCSEQ",30);//FNCSEQ, RORW=RO, INHERIT=Y	
...
$REQ["G3-FNCID"] = reqPostString("G3-FNCID",30);//FNCID, RORW=RW, INHERIT=N	
$REQ["G3-FNCID"] = getFilter($REQ["G3-FNCID"],"CLEARTEXT","/--미 정의--/");	
$REQ["G3-FNCCD"] = reqPostString("G3-FNCCD",30);//FNCCD, RORW=RW, INHERIT=N	
$REQ["G3-FNCCD"] = getFilter($REQ["G3-FNCCD"],"CLEARTEXT","/--미 정의--/");	
$REQ["G3-FNCNM"] = reqPostString("G3-FNCNM",30);//FNCNM, RORW=RW, INHERIT=N	
$REQ["G3-FNCNM"] = getFilter($REQ["G3-FNCNM"],"CLEARTEXT","/--미 정의--/");	
$REQ["G3-FNCTYPE"] = reqPostString("G3-FNCTYPE",30);//FNCTYPE, RORW=RW, INHERIT=N	
$REQ["G3-FNCTYPE"] = getFilter($REQ["G3-FNCTYPE"],"CLEARTEXT","/--미 정의--/");	
$REQ["G3-FNCORD"] = reqPostNumber("G3-FNCORD",3);//FNCORD, RORW=RW, INHERIT=N	
...
$REQ["G3-USERDEFJS"] = reqPostString("G3-USERDEFJS",500);//USERDEFJS, RORW=RW, INHERIT=N	
$REQ["G3-USERDEFJS"] = getFilter($REQ["G3-USERDEFJS"],"CLEARTEXT","/--미 정의--/");	
//,  입력값 필터 
//,  입력값 필터 
array_push($_RTIME,array("[TIME 40.REQ_VALID]",microtime(true)));
	//서비스 클래스 생성
$objService = new pifncService($REQ);
//컨트롤 명령별 분개처리
$log->info("ctl:" . $ctl);
switch ($ctl){
		case "G1_SEARCHALL" :
...
$log->info("PifncControl___________________________end");
$log->close(); unset($log);
?>
