...
<script src="rdrsyslog.js?<?=getRndVal(10)?>"></script>
<script>
		...
		<!--컨디션 IO리스트-->
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--ID오브젝트출력-->
						<input type="text" name="G1-ID" value="<?=getFilter(reqPostString("ID",50),"SAFEECHO","")?>" id="G1-ID" style="width:80;text-align:LEFT" class="">
					</div>
				</div>
				<!--I.COLID : ReceivedAt-->
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--ReceivedAt오브젝트출력-->
						<input type="text" name="G1-ReceivedAt" value="<?=getFilter(reqPostString("ReceivedAt",50),"SAFEECHO","")?>" id="G1-ReceivedAt" style="width:80;text-align:LEFT" class="">
					</div>
				</div>
				<!--I.COLID : FromHost-->
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--FromHost오브젝트출력-->
						<input type="text" name="G1-FromHost" value="<?=getFilter(reqPostString("FromHost",50),"SAFEECHO","")?>" id="G1-FromHost" style="width:80;text-align:LEFT" class="">
					</div>
				</div>
				<!--I.COLID : Message-->
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--Message오브젝트출력-->
						<input type="text" name="G1-Message" value="<?=getFilter(reqPostString("Message",500),"SAFEECHO","")?>" id="G1-Message" style="width:150;text-align:LEFT" class="">
					</div>
				</div>
				<!--I.COLID : SysLogTag-->
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--SysLogTag오브젝트출력-->
						<input type="text" name="G1-SysLogTag" value="<?=getFilter(reqPostString("SysLogTag",50),"SAFEECHO","")?>" id="G1-SysLogTag" style="width:80;text-align:LEFT" class="">
					</div>
				</div>
			</div><!-- is_br_tag end -->
		</div>
