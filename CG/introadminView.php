...
<!--<div id="BODY_BOX" class="BODY_BOX">--><!--그룹별 IO출력-->
 	...
 	<div class="GRP_OBJECT" style="width:100%;">
		...
		<!--컨디션 IO리스트-->
				...
				<div class="CON_OBJGRP" style="">
					<div class="CON_LABEL" style="width:100;text-align:right;">
						FROM_DT
					</div>
					<div class="CON_OBJECT">
						<input type="text" name="G1-FROM_DT" value="" id="G1-FROM_DT" style="width:77;" class="">
					</div>
				</div>
				<!--I.COLID : TO_DT-->
				<div class="CON_OBJGRP" style="">
					<div class="CON_LABEL" style="width:40;text-align:center;">
						TO_DT
					</div>
					<div class="CON_OBJECT">
						<input type="text" name="G1-TO_DT" value="" id="G1-TO_DT" style="width:77;" class="">
					</div>
				</div>
			</div><!-- is_br_tag end -->
		</div>
	...
	#####################################################
	-->
    <div class="GRP_OBJECT" style="width:50%;" id="layout_G2">
        <div class="GRP_GAP"><!--흰색 바깥 여백-->
		...
		<div style="height:152px;" class="FORMVIEW_OBJECT">
			...
			<!--OBJECT LIST PRINT.-->
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<input type="text" name="G2-FROM_DT" value="" id="G2-FROM_DT" style="width:77;" class="">
					</div>
				</div>
				<!--I.COLID : TO_DT-->
				<div class="CON_OBJGRP" style="">
					<div class="CON_LABEL" style="width:40;text-align:left;">
						~
					</div>
					<div class="CON_OBJECT">
						<input type="text" name="G2-TO_DT" value="" id="G2-TO_DT" style="width:77;" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--CFM_DESC오브젝트출력-->
						<input type="text" name="G2-CFM_DESC" value="" id="G2-CFM_DESC" style="width:100;text-align:" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
		</div>
    ...
    <div class="GRP_OBJECT" style="width:50%;height:200px;">
		...
		<div  class="GRID_OBJECT" style="height:calc(100% - 37px);width:100%;">
			<div id="gridG8"  style="background-color:white;overflow:hidden;height:100%;width:100%;"></div>
		</div>
		</div>
    ...
    <div class="GRP_OBJECT" style="width:34%;height:200px;">
		...
		<div  class="GRID_OBJECT" style="height:calc(100% - 37px);width:100%;">
			<div id="gridG9"  style="background-color:white;overflow:hidden;height:100%;width:100%;"></div>
		</div>
		</div>
