		...
		<!--컨디션 IO리스트-->
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--CAMPAIGN_SEQ오브젝트출력-->
						<input type="text" name="G1-CAMPAIGN_SEQ" value="<?=getFilter(reqPostString("CAMPAIGN_SEQ",30),"SAFEECHO","")?>" id="G1-CAMPAIGN_SEQ" style="width:50px;text-align:" class="">
					</div>
				</div>
				<!--I.COLID : CAMPAIGN_NM-->
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--CAMPAIGN_NM오브젝트출력-->
						<input type="text" name="G1-CAMPAIGN_NM" value="<?=getFilter(reqPostString("CAMPAIGN_NM",100),"SAFEECHO","")?>" id="G1-CAMPAIGN_NM" style="width:50px;text-align:" class="">
					</div>
				</div>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--CONTENT_SVRID오브젝트출력-->
						<input type="text" name="G1-CONTENT_SVRID" value="<?=getFilter(reqPostString("CONTENT_SVRID",100),"SAFEECHO","")?>" id="G1-CONTENT_SVRID" style="width:50px;text-align:" class="">
					</div>
				</div>
				<!--I.COLID : CONTENT_NM-->
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--CONTENT_NM오브젝트출력-->
						<input type="text" name="G1-CONTENT_NM" value="<?=getFilter(reqPostString("CONTENT_NM",100),"SAFEECHO","")?>" id="G1-CONTENT_NM" style="width:50px;text-align:" class="">
					</div>
				</div>
				<!--I.COLID : CAHNNEL-->
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--CAHNNEL오브젝트출력-->
						<input type="text" name="G1-CAHNNEL" value="<?=getFilter(reqPostString("CAHNNEL",100),"SAFEECHO","")?>" id="G1-CAHNNEL" style="width:60px;text-align:" class="">
					</div>
				</div>
				<!--I.COLID : TITLE-->
				<div class="CON_OBJGRP" style="">
				...
				<!--I.COLID : MOD_DT-->
				<div class="CON_OBJGRP" style="">
					<div class="CON_LABEL" style="width:60px;text-align:;">
						MOD
					</div>
					<div class="CON_OBJECT">
		...
		<div style="height:652px;" class="FORMVIEW_OBJECT">
			...
			<!--OBJECT LIST PRINT.-->
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--CAMPAIGN_SEQ오브젝트출력-->
						<input type="text" name="G3-CAMPAIGN_SEQ" value="" id="G3-CAMPAIGN_SEQ" style="width:150px;text-align:" class="">
					</div>
				</div>
				<!--I.COLID : CAMPAIGN_NM-->
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--CAMPAIGN_NM오브젝트출력-->
						<input type="text" name="G3-CAMPAIGN_NM" value="" id="G3-CAMPAIGN_NM" style="width:150px;text-align:" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--CONTENT_SVRID오브젝트출력-->
						<input type="text" name="G3-CONTENT_SVRID" value="" id="G3-CONTENT_SVRID" style="width:150px;text-align:" class="">
					</div>
				</div>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						...
						<input type="text" name="G3-CONTENT_IN_COLTYPES" value="" id="G3-CONTENT_IN_COLTYPES" style="width:150px;text-align:" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--CONTENT_NM오브젝트출력-->
						<input type="text" name="G3-CONTENT_NM" value="" id="G3-CONTENT_NM" style="width:100px;text-align:" class="">
					</div>
				</div>
				<!--I.COLID : CAHNNEL-->
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--CAHNNEL오브젝트출력-->
						<input type="text" name="G3-CAHNNEL" value="" id="G3-CAHNNEL" style="width:100px;text-align:" class="">
					</div>
				</div>
				<!--I.COLID : TITLE-->
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--TITLE오브젝트출력-->
						<input type="text" name="G3-TITLE" value="" id="G3-TITLE" style="width:260px;text-align:" class="">
					</div>
				</div>
				<!--I.COLID : BODY-->
				<div class="CON_OBJGRP" style="width:100%;">
