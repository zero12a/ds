...
<script src="layout2a.js?<?=getRndVal(10)?>"></script>
<script>
...
<!--<div id="BODY_BOX" class="BODY_BOX">--><!--그룹별 IO출력-->
	...
	-->
 	<div sytle="width:100%;height:100%">
			...
			<div class="GRP_INNER" style="">	  	<div style="width:0px;height:0px;overflow: hidden"><form id="condition" onsubmit="return false;"></div>
		...
		<!--컨디션 IO리스트-->
				...
				<!--I.COLID : ADDDT-->
				<div class="CON_OBJGRP" style="">
					<div class="CON_LABEL" style="width:;text-align:left;">
						ADDDT
					</div>
					<div class="CON_OBJECT">
						<input type="text" name="G2-ADDDT" value="" id="G2-ADDDT" style="width:47;" class="">
					</div>
				</div>
			</div><!-- is_br_tag end -->
		</div>
