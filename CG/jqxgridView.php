...
<script src="jqxgrid.js?<?=getRndVal(10)?>"></script>
<script>
...
<!--<div id="BODY_BOX" class="BODY_BOX">--><!--그룹별 IO출력-->
	...
	-->
 	<div class="GRP_OBJECT" style="width:100%;">
        <div class="GRP_GAP"><!--흰색 바깥 여백-->
            ...
            <div class="GRP_INNER" style="height:94px;">	  	<div style="width:0px;height:0px;overflow: hidden"><form id="condition" onsubmit="return false;"></div>
		...
		<!--컨디션 IO리스트-->
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--PGMID오브젝트출력-->
						<input type="text" name="G1-PGMID" value="<?=getFilter(reqPostString("PGMID",20),"SAFEECHO","")?>" id="G1-PGMID" style="width:100;text-align:LEFT" class="">
					</div>
				</div>
			</div><!-- is_br_tag end -->
		</div>
	...
	#####################################################
	-->
    <div class="GRP_OBJECT" id="divGrpG2" style="width:50%;" id="layout_G2">
        <div class="GRP_GAP"><!--흰색 바깥 여백-->
	...
	#####################################################
	-->
    <div class="GRP_OBJECT" id="divGrpG3" style="width:50%;" id="layout_G3">
        <div class="GRP_GAP"><!--흰색 바깥 여백-->
		<div  class="GRID_LABELGRP">
			<div class="GRID_LABELGRP_GAP">	<!--그리드만 필요-->
