		...
		<div style="height:352px;" class="FORMVIEW_OBJECT">
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					<div class="CON_LABEL" style="width:60;text-align:left;">	
					DSEQ	
					</div>
					<!-- style="width:60;"-->
					<div class="CON_OBJECT">
						<div name="G4-LAUTHD_SEQ" id="G4-LAUTHD_SEQ" style="background-color:white; width:60;height:22;line-height:22px;vertical-align:middle;padding:0px 0px 0px 3px"></div>
					</div>
				</div>
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:60;"-->
					<div class="CON_OBJECT">
						<div name="G4-ADD_DT" id="G4-ADD_DT" style="background-color:white; width:60;height:22;line-height:22px;vertical-align:middle;padding:0px 0px 0px 3px"></div>
					</div>
				</div>
			</DIV><!--is_br_tab end-->
		</div>
