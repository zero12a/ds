    ...
    <div class="GRP_OBJECT" style="width:100%;height:700px;"> 
		...
		<div  class="GRID_LABELGRP">
			...
			<div id="div_gridG2_GRID_LABELBTN" class="GRID_LABELBTN"  style="">
				...
				<input type="text" id="FILE_G2-ELOAD_LABEL" class="file_input_textbox" readonly="readonly">
				<div class="file_input_div">
					<input type="button" value="Load excel" class="btn-sm">
					<input type="file" id="FILE_G2-ELOAD" class="file_input_hidden" onchange="javascript:document.getElementById('FILE_G2-ELOAD_LABEL').value = this.value.split('\\')[this.value.split('\\').length-1]">
				</div>
