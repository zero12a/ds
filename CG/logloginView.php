...
<!--<div id="BODY_BOX" class="BODY_BOX">--><!--그룹별 IO출력-->
 	...
 	<div class="GRP_OBJECT" style="width:100%;">
		...
		<!--컨디션 IO리스트-->
				...
				<div class="CON_OBJGRP" style="">
					<div class="CON_LABEL" style="width:100;text-align:center;overflow:hidden;">
						USR_ID
					</div>
					<!-- style="width:100;"-->
					<div class="CON_OBJECT">
						<!--USR_ID오브젝트출력-->
						<input type="text" name="G1-USR_ID" value="<?=getFilter(reqPostString("USR_ID",10),"SAFEECHO","")?>" id="G1-USR_ID" style="width:100;text-align:" class="">
					</div>
				</div>
				<!--I.COLID : REMOTE_ADDR-->
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--REMOTE_ADDR오브젝트출력-->
						<input type="text" name="G1-REMOTE_ADDR" value="<?=getFilter(reqPostString("REMOTE_ADDR",20),"SAFEECHO","")?>" id="G1-REMOTE_ADDR" style="width:120;text-align:" class="">
					</div>
				</div>
				<!--I.COLID : FROM_DT-->
				<div class="CON_OBJGRP" style="">
	...
	#####################################################
	-->
    <div class="GRP_OBJECT" style="width:65%;height:600px;">
        <div class="GRP_GAP"><!--흰색 바깥 여백-->
	...
	#####################################################
	-->
    <div class="GRP_OBJECT" style="width:35%;" id="layout_G3">
        <div class="GRP_GAP"><!--흰색 바깥 여백-->
		...
		<div style="height:552px;" class="FORMVIEW_OBJECT">
			...
			<!--OBJECT LIST PRINT.-->
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--LOGIN_SEQ오브젝트출력-->
						<input type="text" name="G3-LOGIN_SEQ" value="" id="G3-LOGIN_SEQ" style="width:120;text-align:LEFT" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:200;"-->
					<div class="CON_OBJECT">
						<div name="G3-SESSION_ID" id="G3-SESSION_ID" style="background-color:white; width:200;height:22;line-height:22px;vertical-align:middle;padding:0px 0px 0px 3px"></div>
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:240;"-->
					<div class="CON_OBJECT">
						<div name="G3-USER_AGENT" id="G3-USER_AGENT" style="background-color:white; width:240;height:80;line-height:80px;vertical-align:middle;padding:0px 0px 0px 3px"></div>
					</div>
				</div>
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT" style="">
						<textarea  name="G3-AUTH_JSON"  id="G3-AUTH_JSON" style="padding:2px 2px 2px 2px;width:340;height:460"></textarea>
					</div>
				</div>
			</DIV><!--is_br_tab end-->
		</div>
