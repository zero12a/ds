		...
		<!--컨디션 IO리스트-->
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--SQLNM오브젝트출력-->
						<input type="text" name="G1-SQLNM" value="<?=getFilter(reqPostString("SQLNM",30),"SAFEECHO","")?>" id="G1-SQLNM" style="width:60;text-align:LEFT" class="">
					</div>
				</div>
			</div><!-- is_br_tag end -->
		</div>
		...
		<div style="height:452px;" class="FORMVIEW_OBJECT">
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<!-- style="width:50;"-->
					<div class="CON_OBJECT">
						<div name="G3-SQLSEQ" id="G3-SQLSEQ" style="background-color:white; width:50;height:22;line-height:22px;vertical-align:middle;padding:0px 0px 0px 3px"></div>
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--SQLID오브젝트출력-->
						<input type="text" name="G3-SQLID" value="" id="G3-SQLID" style="width:60;text-align:LEFT" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--SQLNM오브젝트출력-->
						<input type="text" name="G3-SQLNM" value="" id="G3-SQLNM" style="width:60;text-align:LEFT" class="">
					</div>
				</div>
			</DIV>
			<DIV class="OBJ_BR"></DIV>
			...
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--SQLORD오브젝트출력-->
						<input type="text" name="G3-SQLORD" value="" id="G3-SQLORD" style="width:30;text-align:LEFT" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
			<DIV class="CON_LINE" is_br_tag>
				...
				<div class="CON_OBJGRP" style="">
					...
					<div class="CON_OBJECT">
						<!--PSQLSEQ오브젝트출력-->
						<input type="text" name="G3-PSQLSEQ" value="" id="G3-PSQLSEQ" style="width:70;text-align:LEFT" class="">
					</div>
				</div>
			</DIV><!--is_br_tab end-->
			<DIV class="OBJ_BR"></DIV>
