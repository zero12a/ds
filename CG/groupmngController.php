...
require_once('groupmngService.php');
...
$log->info("GroupmngControl___________________________start");
...
array_push($_RTIME,array("[TIME 40.REQ_VALID]",microtime(true)));
	//서비스 클래스 생성
$objService = new groupmngService($REQ);
//컨트롤 명령별 분개처리
$log->info("ctl:" . $ctl);
switch ($ctl){
		case "G1_SEARCHALL" :
...
$log->info("GroupmngControl___________________________end");
$log->close(); unset($log);
?>
